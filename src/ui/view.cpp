...
void View::do_mouse_press(MouseButton button, double x, double y)
{
    on_mouse_press(button, x, y);
}
void View::do_mouse_release(MouseButton button, double x, double y)
{
    on_mouse_release(button, x, y);
}
void View::do_mouse_moved(double x, double y)
{
    on_mouse_moved(x, y);
}
void View::do_mouse_wheel(bool is_horizontal, double delta)
{
